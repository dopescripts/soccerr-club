            ...
            <div class="container-fluid py-3 w-100 align-items-center">
                ...
                <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div class="row w-100 align-items-center pb-2">
                                                <div class="col-4 ps-3 pe-2">
                                                    <a href="{{ route('product', $item->product->slug) }}">
                                                        <img src="{{ asset('storage/uploads/products' . '/' . $item->product->thumb) }}" class="img-fluid rounded" />
                                                    </a>
                                                </div>
                                                <div class="col-7 px-0">
                                                    ...
                                                    <span class="current-price fw-normal text-secondary fs-6 py-2">
                                                        ${{ number_format($item->product->price - $item->product->price * $item->product->discount_percentage, 2) }}
                                                    </span>
                                                </div>
                                                <div class="col-1">
                                                    <a href="{{ route('wishlist.remove', $item->product->slug) }}" class="link-dark"><i class="fa-solid fa-trash-can text-secondary"></i></a>
                                                </div>
                                            </div>
                                            <hr />
                                        </div>
                    ...
                    <a data-bs-toggle="offcanvas" href="#offcanvasCart" role="button" aria-controls="offcanvasExample" class="link-light text-decoration-none fw-semibold d-flex align-items-center gap-1">
                        @if ($cart != null)
                            <span>${{ number_format($cart->getTotalAttribute(), 2) }}</span>
                        @endif
                                                    ...
                                                    <div class="row w-100 align-items-center pb-2">
                                                        <div class="col-4 ps-3 pe-2">
                                                            <a href="{{ route('product', $cartitem->product->slug) }}">
                                                                <img src="{{ asset('storage/uploads/products' . '/' . $cartitem->product->thumb) }}" class="img-fluid rounded" />
                                                            </a>
                                                        </div>
                                                        <div class="col-7 px-0">
                                                            <a href="#" class="text-decoration-none fw-semibold link-dark">
                                                                <p class="mb-0 fs-5">{{ Str::limit($cartitem->product->name, 36) }}</p>
                                                            </a>
                                                            <span
                                                                class="current-price fw-normal text-secondary fs-6 py-2">${{ number_format($cartitem->product->price - $cartitem->product->price * $cartitem->product->discount_percentage, 2) }}</span>
                                                            <div class="d-flex align-items-center my-1">
                                                                <button class="btn btn-outline-secondary p-0" onclick="minusCart(this)"><i class="bi bi-dash fs-6 p-0"></i></button>
                                                                <input type="text" class="form-control form-control-sm shadow-none outline-none bg-light py-0 my-0 cartquant" value="{{ $cartitem->quantity }}" />
                                                                <button class="btn btn-outline-secondary p-0" onclick="addCart(this)"><i class="bi bi-plus fs-6 p-0"></i></button>
                                                            </div>
                                                        </div>
                                                        <div class="col-1">
                                                            <a href="{{ route('cart.remove', $cartitem->product->slug) }}" class="link-dark"><i class="fa-solid fa-trash-can text-secondary"></i></a>
                                                        </div>
                                                    </div>
                                                    <hr />
                                                </div>
                                        ...
                                        <div class="w-100">
                                            <div class="container-fluid py-2 bg-primary-subtle pb-4 border-top">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <p class="fw-semibold m-0">${{ number_format($cart->getTotalAttribute(), 2) }}</p>
                                                </div>
                                                <div class="d-flex justify-content-between align-items-center">
