            ...
            <div class="d-flex align-items-center">
              <div class="d-flex gap-3 justify-content-between align-items-center w-100">
                <div class="d-flex align-items-center gap-3">
                  <img src="assets/images/asset 3.jpeg" alt="" class="img-fluid w-25 rounded border border-dark-subtle" />
                  <!-- <span class="badge text-bg-dark position-absolute top-0">01</span> -->
                  <p class="my-0">Legs wearing</p>
                </div>
                <div>
                    <span class="fw-semibold">$25.50</span>
                  </div>
              </div>
            </div>
          </div>
