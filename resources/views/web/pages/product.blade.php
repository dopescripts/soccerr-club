                ...
                <div class="card-body card-bg border py-4 rounded-4 px-4">
                    ...
                    <div class="d-md-flex justify-content-between align-items-center my-3">
                        ...
                        <div class="action d-flex align-items-center gap-3">
                            <a href="#"
                                class="link-dark link-underline-opacity-0 link-underline-opacity-100-hover link-offset-1-hover text-black"><i
                                    class="bi bi-layers"></i> Add to Compare</a>
                            <a href="#"
                                class="link-dark link-underline-opacity-0 link-underline-opacity-100-hover link-offset-1-hover text-black"><i
                                    class="bi bi-heart"></i> Add to Wishlist</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-6 col-8 my-3 mt-1 mx-auto mx-lg-0">
                        <div class="input-group w-100 border">
                            <button class="btn btn-light rounded-0" onclick="minusCart()"><i
                                    class="bi bi-dash fs-4"></i></button>
                            <input type="text" class="form-control shadow-none outline-none border-0 bg-light" value="1"
                                id="cartquant" />
                            <button class="btn btn-light rounded-0" onclick="addCart()"><i
                                    class="bi bi-plus fs-4"></i></button>
                        </div>
                    </div>
                    <script>
                    ...
                    <!-- <div class="my-2"><i class="bi bi-eye bg-secondary text-light px-3 py-2 rounded-pill"></i> 18 people are viewing this right now</div> -->
                    <div class="d-flex flex-column flex-lg-row gap-2 align-items-center my-3">
                        <button type="button" class="btn btn-secondary shadow-sm flex-grow-1 flex-lg-0"><i
                                class="bi bi-cart"></i> Add to Cart</button>
                        <button type="button" class="btn btn-dark flex-grow-1">Buy it Now</button>
                    </div>
                    <div class="d-flex align-items-center justify-content-between px-1">
                        <a href="#"
                            class="link-dark fw-semibold link-underline-opacity-0 link-offset-1 link-underline-opacity-100-hover"><i
                                class="bi bi-shield"></i> Shipping and Returns</a>
                        <a href="#"
                            class="link-dark fw-semibold link-underline-opacity-0 link-offset-1 link-underline-opacity-100-hover"><i
                    ...
                    <div class="d-inline-flex align-items-center text-muted fw-semibold">
                        <i class="bi bi-rocket-takeoff pe-2 fs-5"></i> <span>Estimated Delivery: <small
                                class="text-dark fw-bold">31 Dec - 3 Jan</small></span>
                    </div>
                    <div class="d-inline-flex align-items-center text-muted fw-semibold">
    ...
    <div class="container py-5 mt-5">
        <ul class="nav nav-pills gap-2" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active shadow-none" id="home-tab" data-bs-toggle="tab"
                    data-bs-target="#description-tab-pane" type="button" role="tab" aria-controls="home-tab-pane"
                    aria-selected="true">Description</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link shadow-none" id="profile-tab" data-bs-toggle="tab"
                    data-bs-target="#review-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane"
                    aria-selected="false">Reviews <i class="bi bi-star-fill"></i></button>
            </li>
        </ul>
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="description-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                tabindex="0">
                <div class="my-5">
                    {!! $product->description !!}
                </div>
