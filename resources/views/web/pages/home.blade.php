...
<section class="w-100 hero">
    ...
    <div id="carouselExampleCaptions" class="carousel slide">
            ...
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    ...
                    <div class="my-lg-5 my-2">
                        <a href="{{ route('products') }}" class="btn btn-primary mb-2 mb-md-0">SHOP NOW <i
        ...
        <button class="carousel-control-prev ms-1" style="width: 30px !important" type="button"
            data-bs-target="#carouselExampleCaptions" data-bs-slide="prev">
            <span class="carousel-control-prev-icon rounded-circle bg-dark text-dark" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
        </button>
        <button class="carousel-control-next me-1" style="width: 30px !important" type="button"
                ...
                <a href="{{ route('category.detail', $category->id) }}">
                    <div class="card card-bg">
                        <div class="card-body text-center p-2 rounded-3">
                            <img loading="lazy" src="{{ asset('public/'. $category->image) }}" alt=""
                                class="img-fluid rounded bg-white p-2" />
                            <div class="card-subtitle mt-3"><a href="product.html"
                                    class="link-dark fw-semibold text-decoration-none text-uppercase">{{ $category->name
                                    }}</a></div>
    ...
    <div class="container-fluid px-lg-3">
        <div class="heading mb-2">
            ...
            <div class="d-flex justify-content-between align-items-baseline">
                ...
                <a href="{{ route('products') }}" class="link-danger fw-semibold pe-lg-2 link-offset-1-hover">SEE ALL
                    PRODUCTS</a>
            </div>
        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                <div class="card rounded-4 card-bg p-3">
                    <div class="card-body">
                        <div class="icon">
                            <img loading="lazy"
                                src="https://soccer-club-shop.myshopify.com/cdn/shop/files/icon-01.png?v=1730104391"
                                alt="" class="bg-danger rounded p-3" />
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                <div class="card rounded-4 card-bg p-3">
                    <div class="card-body">
                        <div class="icon">
                            <img loading="lazy"
                                src="https://soccer-club-shop.myshopify.com/cdn/shop/files/icon-02.png?v=1730104391"
                                alt="" class="bg-danger rounded p-3" />
                        </div>
                        <div class="text-start text-md-center px-md-2 mt-3">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                <div class="card rounded-4 card-bg p-3">
                    <div class="card-body">
                        <div class="icon">
                            <img loading="lazy"
                                src="https://soccer-club-shop.myshopify.com/cdn/shop/files/icon-03.png?v=1730104391"
                                alt="" class="bg-danger rounded p-3" />
                        </div>
                        <div class="text-start text-md-center px-md-2 mt-3">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                <div class="card rounded-4 card-bg p-3">
                    <div class="card-body">
                        <div class="icon">
                            <img loading="lazy"
                                src="https://soccer-club-shop.myshopify.com/cdn/shop/files/icon-04.png?v=1730104391"
                                alt="" class="bg-danger rounded p-3" />
                        </div>
                        <div class="text-start text-md-center px-md-2 mt-3">
                    ...
                    <div class="team-img position-relative overflow-hidden text-center">
                        ...
                        <div class="position-absolute top-0 start-0 team-link">
                            <div class="d-flex flex-column gap-2 mt-2 ms-3">
                                <a href="#" class="footer-link"><img loading="lazy" src="/assets/images/asset 61.svg"
                                        alt="" /></a>
                                <a href="#" class="footer-link"><img loading="lazy" src="/assets/images/asset 62.svg"
                                        alt="" /></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                <div class="card card-bg overflow-hidden rounded-4">
                    <div class="position-relative">
                        <img loading="lazy" src="/assets/images/asset 26.jpeg"
                            class="card-img-top p-3 pb-0 rounded overflow-hidden" alt="..." />
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted mb-1 py-2">Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Vel....</p>
                        <a href="#" class="link-dark fw-semibold text-decoration-none">Read More <i
                                class="fa-solid fa-arrow-right ps-lg-1"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 col-12">
