                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="position-relative">
                                                            @foreach (json_decode($order->order_items, true) as $orderItem)
                                                                <a href="{{ route('product', $orderItem['product_id']) }}" class="text-decoration-none link-primary" target="_blank">
                                                                    <div class="ms-2 d-flex align-items-center my-3">
                                                                        <div class="d-sm-flex gap-3 justify-content-between align-items-center w-100">
                                                                            <div class="d-md-flex align-items-center gap-3">
                                                                                <p class="my-0">{{ $orderItem['product_name'] }}</p>
                                                                            </div>
                                                                            <div>
                                                                                <span class="fw-semibold">{{ "$" . $orderItem['price'] }}</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </a>
